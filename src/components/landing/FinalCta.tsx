  ...
  return (
    <section className="py-24 border-t-[3px] border-[#0A0A0A] bg-[#0A0A0A] text-white">
      <div className="max-w-7xl mx-auto px-6">
        <div className="border-[3px] border-[#0A0A0A] bg-white text-[#0A0A0A] p-8 sm:p-16 text-center space-y-8 shadow-[8px_8px_0_#E73520]">
          ...
          <h2 className="text-4xl sm:text-6xl lg:text-7xl font-black uppercase tracking-tight text-[#0A0A0A] leading-none">
            EVERY DOCUMENT. EVERY REVIEW.
            <br />
            CLEARLY TRACED.
          </h2>

          <p className="text-base sm:text-lg font-medium max-w-2xl mx-auto text-[#0A0A0A]">
